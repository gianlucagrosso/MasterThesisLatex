...
\begin{definition}[Rank-revealing algorithm]
	...
	\[
		\renewcommand{\arraystretch}{1.1}% (optional) a touch of extra vertical room
		\begin{array}{r c >{{}}c<{{}} c} 
		\mathcal{A}: &
	...
	is said to be {\normalfont \textbf{rank-revealing}}, if it ouputs a low-rank approximation $\widetilde{\mathcal{T}}$ for any compressible tensor $\mathcal{T}$\footnotemark given as input.
	\label{def:rkralg}
\end{definition}
